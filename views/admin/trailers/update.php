<?php
  ...
  $trailer = TrailerDao::getById($idTrailer);
?>
  ...
  <div class="container-fluid" style="height: 90vh">
    <div class="row h-100">
      ...
      <div class="col-md-10  p-4 borber">
        <div class="card">
          <form method="post" enctype="multipart/form-data" action="../../../controllers/trailerController.php" class="needs-validation" novalidate>
            <input type="hidden" name="option" value="UPDATE">
            <input type="hidden" name="id" value="<?php echo $idTrailer ?>">
            <div class="card-header">
              <strong>INFORMAÇÕES DO TRAILER</strong>
            </div>
            <div class="card-body row justify-content-center align-items-center">
              <div class="col-md-2 text-center">
                <div class="bg-white rounded img-fluid">
                  <img id="imagemPreview" src="../../img/user/<?php echo $trailer['capaTrailer'] ?>" alt="" class="img-fluid">
                </div>
              </div>
              <div class=" col-md-9">
                <div class="row">
                  <div class="col-md-5 mb-4">
                    ...
                    <input type="text" class="form-control" name="titulo" value="<?php echo $trailer['tituloTrailer'] ?>" maxlength="255">
                  </div>
                  <div class="col-md-4">
                    <label for="email" class="col-form-label">Link:</label>
                    <input type="text" class="form-control" name="link" value="<?php echo $trailer['linkTrailer'] ?>" id="email" required>
                  </div>
