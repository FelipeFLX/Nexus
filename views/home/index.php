    ...
    <div class="container-all">
        ...
        <div class="noticias">
            <div class="card cards" style="width: 20rem; background-color: rgba(12,12,12, 0.50);">
                <img src="/Nexus/public/img/Noticias/BGS.png" class="card-img-top" alt="Imagem Noticia">
                <div class="card-body">
            ...
            <div class="card cards" style="width: 20rem; background-color: rgba(12,12,12, 0.50);">
                <img src="/Nexus/public/img/Noticias/Pokemon.png" class="card-img-top" alt="Imagem Noticia">
                <div class="card-body">
            ...
            <div class="card cards" style="width: 20rem; background-color: rgba(12,12,12, 0.50);">
                <img src="/Nexus/public/img/Noticias/FC24.png" class="card-img-top" alt="Imagem Noticia">
                <div class="card-body">
            ...
            <div class="card cards" style="width: 20rem; background-color: rgba(12,12,12, 0.50);">
                <img src="/Nexus/public/img/Noticias/terror.png" class="card-img-top" alt="Imagem Noticia">
                <div class="card-body">
            ...
            <div class="card cards" style="width: 20rem; background-color: rgba(12,12,12, 0.50);">
                <img src="/Nexus/public/img/Noticias/mk1.jpg" class="card-img-top" alt="Imagem Noticia">
                <div class="card-body">
